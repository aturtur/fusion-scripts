...
def open_macro_folder() -> None:
    ...
    if resolve:
        macros_dir = pathlib.Path.home() / "AppData" / "Roaming" / "Blackmagic Design" / "DaVinci Resolve" / "Support" / "Fusion" / "Macros"
    else:
        macros_dir = pathlib.Path.home() / "AppData" / "Roaming" / "Blackmagic Design" / "Fusion" / "Macros"
    subprocess.Popen(["explorer", macros_dir])

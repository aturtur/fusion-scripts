"""
AR_StackHorizontally

Author: Arttu Rautio (aturtur)
Website: http://aturtur.com/
Name-US: Stack Horizontally
Version: 1.0.0
Description-US: Stack selected tools horizontally, based on node positions in Flow.
...
def stack_horizontally(align: str) -> None:

...
Name-US: Scale To Fit Comp Width
Version: 1.0.0
Description-US: Scales proportionally foreground image to fit background image's width.
...
def fit_comp_width(tool) -> None:
    ...
    transform_node.SetAttrs({"TOOLS_Name": "FitToCompWidth"})
